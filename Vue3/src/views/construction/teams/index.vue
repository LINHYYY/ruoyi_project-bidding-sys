<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          icon="Plus"
          @click="handleAdd"
          v-hasPermi="['construction:teams:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['construction:teams:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['construction:teams:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          icon="Download"
          @click="handleExport"
          v-hasPermi="['construction:teams:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="teamsList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="序号" type="index" align="center" prop="teamId" width="50" />
      ...
      <el-table-column label="资质等级" align="center" prop="qualificationLevel">
        <template #default="scope">
          <dict-tag :options="aptitude_grade" :value="scope.row.qualificationLevel"/>
        </template>
      </el-table-column>
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template #default="scope">
          <el-button link type="primary" icon="Edit" @click="handleUpdate(scope.row)" v-hasPermi="['construction:teams:edit']">修改</el-button>
          <el-button link type="primary" icon="Delete" @click="handleDelete(scope.row)" v-hasPermi="['construction:teams:remove']">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
...
import { listTeams, getTeams, delTeams, addTeams, updateTeams } from "@/api/construction/teams";

const { proxy } = getCurrentInstance();
const { aptitude_grade } = proxy.useDict('aptitude_grade');
...
function handleDelete(row) {
  ...
  proxy.$modal.confirm('是否确认删除施工队列表编号为"' + _teamIds + '"的数据项？').then(function() {
...
function handleExport() {
  proxy.download('construction/teams/export', {
    ...queryParams.value
